...
def build(repository=None):
    ...
    files = {
        ...
        'codex-translation.js': (ROOT / 'src/codex-translation.js').read_bytes(),
        'preferences.xhtml': (ROOT / 'src/preferences.xhtml').read_bytes(),
        'preferences.js': (ROOT / 'src/preferences.js').read_bytes(),
        'preferences.css': (ROOT / 'src/preferences.css').read_bytes(),
